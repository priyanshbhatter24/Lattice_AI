    ...
    return [
        ...
        LocationRequirement(
            ...
            constraints=Constraints(
                ...
                power_requirements="heavy_duty",
                acoustic_needs="action_ok",
                special_requirements=["large windows/skylights", "no active business"],
            ),
        ...
        LocationRequirement(
            ...
            constraints=Constraints(
                interior_exterior="interior",
                time_of_day="night",
                min_ceiling_height_ft=None,
                min_floor_space_sqft=2000,
                parking_spaces_needed=10,
        ...
        LocationRequirement(
            ...
            constraints=Constraints(
                ...
                time_of_day="day",
                min_ceiling_height_ft=None,
                min_floor_space_sqft=1500,
                parking_spaces_needed=8,
                power_requirements="standard_120v",
                acoustic_needs="dialogue_heavy",
        ...
        LocationRequirement(
            ...
            constraints=Constraints(
                ...
                time_of_day="day",
                min_ceiling_height_ft=None,
                min_floor_space_sqft=1000,
                parking_spaces_needed=6,
                power_requirements="standard_120v",
                acoustic_needs="dialogue_heavy",
        ...
        LocationRequirement(
            ...
            constraints=Constraints(
                ...
                time_of_day="night",
                min_ceiling_height_ft=None,
                min_floor_space_sqft=None,
                parking_spaces_needed=20,
                power_requirements="standard_120v",
                acoustic_needs="dialogue_heavy",
